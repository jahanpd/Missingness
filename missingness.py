...
from data import spiral_missing
import os
...
def run(iterations, missing="None", epochs=10):
    ...
    for i in range(iterations):
        X, y, _ = spiral_missing(2048, missing=missing, rng_key=i)
        model1 = UAT(
...
run(10, epochs=50, missing="None")
run(10, epochs=50, missing="MCAR")
run(10, epochs=50, missing="MAR")
run(10, epochs=50, missing="NMAR")