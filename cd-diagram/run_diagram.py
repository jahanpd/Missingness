import pandas as pd
from orange import draw_cd_diagram
import itertools
import os
import argparse
...
if not args.corrupt:
    ...
    print(df_perf)
    draw_cd_diagram(df_perf=df_perf, title='Accuracy', labels=True, savename="./uncorrupted-cd-diagram-acc.png")
    ...
    df_perf = pd.DataFrame(df_perf)
    print(df_perf)
    draw_cd_diagram(df_perf=df_perf, title='NLL', labels=True, savename="./uncorrupted-cd-diagram-nll.png")
    ...
    for missingness in ["MNAR", "MAR", "MCAR"]:
        ...
        df_perf = pd.DataFrame(df_perf)
        print(df_perf)
        draw_cd_diagram(df_perf=df_perf, title='Change in Accuracy', labels=True, savename="./{}-cd-diagram-acc.png".format(missingness.lower()))
    ...
    for missingness in ["MNAR", "MAR", "MCAR"]:
        ...
        df_perf = pd.DataFrame(df_perf)
        print(df_perf)
        draw_cd_diagram(df_perf=df_perf, title='Change in NLL', labels=True, savename="./{}-cd-diagram-nll.png".format(missingness.lower()))
